...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/solvers/heuristic-improvement/twoOptInversion.worker.js");
/******/ })
/************************************************************************/
/******/ ({
  ...
  while (swapped) {
    ...
    for (let pt1 = 1; pt1 < path.length - 1; pt1++) {
      for (let pt2 = pt1 + 1; pt2 < path.length - 1; pt2++) {
        ...
        // calculate new cost
        const newPath = path;
        const cost = Object(_cost__WEBPACK_IMPORTED_MODULE_1__["pathCost"])(newPath);
        ...
        self.setEvaluatingPaths(() => ({
          paths: [{ path, color: _constants__WEBPACK_IMPORTED_MODULE_2__["EVALUATING_SEGMENT_COLOR"] }]
        }));
        await self.sleep();
      }
    }
...
Object(_makeSolver__WEBPACK_IMPORTED_MODULE_0__["default"])(twoOptInversion);
...
/******/ });
//# sourceMappingURL=a31c7e29dd94fe29dd09.worker.js.map