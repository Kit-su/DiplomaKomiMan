...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/solvers/heuristic-construction/nearestInsertion.worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
const nearestInsertion = async points => {
  ...
  //
  points.sort((a, b) => Object(_cost__WEBPACK_IMPORTED_MODULE_1__["distance"])(path[0], b) - Object(_cost__WEBPACK_IMPORTED_MODULE_1__["distance"])(path[0], a));
  ...
  while (points.length > 0) {
    ...
    for (const [freePointIdx, freePoint] of points.entries()) {
      for (const pathPoint of path) {
        const dist = Object(_cost__WEBPACK_IMPORTED_MODULE_1__["distance"])(freePoint, pathPoint);
    ...
    for (let i = 1; i < path.length; i++) {
      const insertionCost = Object(_cost__WEBPACK_IMPORTED_MODULE_1__["pathCost"])([path[i - 1], nextPoint, path[i]]);
...
Object(_makeSolver__WEBPACK_IMPORTED_MODULE_0__["default"])(nearestInsertion);
...
/******/ });
//# sourceMappingURL=cd26bf04c2f0273ce3c1.worker.js.map