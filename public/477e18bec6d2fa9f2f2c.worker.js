...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/solvers/heuristic-construction/convexHull.worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
const convexHull = async points => {
  ...
  while (true) {
    ...
    for (let [idx, p] of points.entries()) {
          ...
          paths: [
            {
              ...
              color: _constants__WEBPACK_IMPORTED_MODULE_2__["EVALUATING_SEGMENT_COLOR"]
            },
            { path: [curPoint, p], color: _constants__WEBPACK_IMPORTED_MODULE_2__["EVALUATING_PATH_COLOR"] }
          ]
        }),
        2
      );
      ...
      if (!selectedPoint || Object(_cost__WEBPACK_IMPORTED_MODULE_1__["counterClockWise"])(curPoint, p, selectedPoint)) {
  ...
  while (points.length > 0) {
    ...
    for (let [freeIdx, freePoint] of points.entries()) {
      ...
      for (let [pathIdx, pathPoint] of path.entries()) {
        ...
        const evalCost =
          Object(_cost__WEBPACK_IMPORTED_MODULE_1__["pathCost"])([pathPoint, freePoint, nextPathPoint]) -
          Object(_cost__WEBPACK_IMPORTED_MODULE_1__["pathCost"])([pathPoint, nextPathPoint]);
      ...
      const prevCost = Object(_cost__WEBPACK_IMPORTED_MODULE_1__["pathCost"])([path[bestIdx], nextPoint]);
      const newCost = Object(_cost__WEBPACK_IMPORTED_MODULE_1__["pathCost"])([path[bestIdx], freePoint, nextPoint]);
...
Object(_makeSolver__WEBPACK_IMPORTED_MODULE_0__["default"])(convexHull);
...
/******/ });
//# sourceMappingURL=477e18bec6d2fa9f2f2c.worker.js.map