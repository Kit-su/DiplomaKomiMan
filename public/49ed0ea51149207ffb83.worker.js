...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/solvers/exhaustive/branchAndBoundOnCostAndCross.worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
const branchAndBoundOnCostAndCross = async (
  ...
  const available = Object(_cost__WEBPACK_IMPORTED_MODULE_1__["setDifference"])(points, visited);
  ...
  if (path.length > 3) {
    ...
    for (let i = 1; i < path.length - 2; i++) {
      if (Object(_cost__WEBPACK_IMPORTED_MODULE_1__["intersects"])(path[i], path[i - 1], ...newSegment)) {
          ...
          () => ({
            paths: [
              ...
              },
              {
                ...
                color: _constants__WEBPACK_IMPORTED_MODULE_2__["EVALUATING_ERROR_COLOR"]
              }
            ],
            cost
          }),
  ...
  self.setEvaluatingPaths(
    () => ({
      paths: [
        ...
        {
          path: path.slice(path.length - 2, path.length + 1),
          color: _constants__WEBPACK_IMPORTED_MODULE_2__["EVALUATING_PATH_COLOR"]
        }
      ],
      cost
    }),
...
Object(_makeSolver__WEBPACK_IMPORTED_MODULE_0__["default"])(branchAndBoundOnCostAndCross);
...
/******/ });
//# sourceMappingURL=49ed0ea51149207ffb83.worker.js.map